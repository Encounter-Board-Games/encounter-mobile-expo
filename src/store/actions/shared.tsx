...
export const handleInitHome = (): ThunkAction<void, RootState, unknown, Action<string>> => {
...
export const handleInitApp = (): ThunkAction<void, RootState, unknown, Action<string>> => {
  return async (dispatch) => {
    try {
      await Promise.all([
...
export const handleSetCartChoseAddress = (type: string, deliveryTypeMode: string): ThunkAction<void, RootState, unknown, Action<string>> => {
  return (dispatch) => {
...
export const handleCloseCartChoseAddress = (): ThunkAction<void, RootState, unknown, Action<string>> => {
  return (dispatch) => {
...
export const handleSetCartChosePayment = (): ThunkAction<void, RootState, unknown, Action<string>> => {
  return (dispatch) => {
    dispatch(setChosePaymentMethodsMode(true));
  };
};

export const handleCloseSetCartChosePayment = (): ThunkAction<void, RootState, unknown, Action<string>> => {
  return (dispatch) => {
...
export const registerRedirectComponent = (callback: (screen: string) => void): void => {
...
export const handleProcessActions = (action: string | undefined): ThunkAction<void, RootState, unknown, Action<string>> => {
  return async (dispatch) => {
    if (!action) return;
    ...
    export const handleOpenNotification = (key: string, action: string | undefined): ThunkAction<void, RootState, unknown, Action<string>> => {
    ...
    export const handleSelectFilterToggle = (type: string, e: boolean): ThunkAction<void, RootState, unknown, Action<string>> => {
