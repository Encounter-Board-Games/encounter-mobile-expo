...
export function appSetConfiguration(about: { phone: string; instagram: any; name: any; nameAbout: string; aboutText: any; }){
    return {
...
export function handleLoadAppConfig(){
    return async (dispatch: (arg0: { type: string; about?: any; terms?: any; }) => void) => {
...
export function handleCancelUpdate(){
    return async (dispatch: (arg0: { type: string; update: any; }) => void, getState: () => { app: any; }) => {
        const { app } = getState()
        const { update = {} } = app;
