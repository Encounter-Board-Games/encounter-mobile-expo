...
import { setChips, setFilteringResultLoading, setFilteringResult, setNumberOfFilters } from "./filters";
import { handleSetSelects } from "./handleSetFilters";
import { IAction, IFilterState, IState, IClearButtonProps, IFilterChipsProps, IFilterSelectProps, IFilterBarProps, IFilter } from "./filterTypes";
...
export function setSelectsDefault(selected: { [key: string]: string[] }): IAction {
  return {
