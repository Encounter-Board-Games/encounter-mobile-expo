...
import { IAction, IState, IFilterState, IFilterSelectProps, IFilterChipsProps } from "./filterTypes";
...
export function setFilteringResult(result: number[], loading: boolean): IAction {
  return {
