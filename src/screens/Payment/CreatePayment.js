...
import { handleCreateOrEditPayment, handleSetCurrentPayment, handleRemoveCurrentPaymentConfirmModal } from '../../store/actions/payments';
                                ...
                                this.state.isEdit ?
                                    ...
                                    <Input field
                                        ...
                                        format={(value) => {
                                            ...
                                            return chunk(valueToFormat.split(''), 4).map(i => i.join('')).join(' ')
                                        }}
